...
**Fev/2022 – Dez/2022 (11m)**
- Análise de dados (Power BI, Python/Pandas) identificando padrões de falhas FTTH

---

### **Operador de Telemarketing** | Sea Telecom  
**Set/2020 – Fev/2022 (1a 6m)**
- Diagnóstico de rede FTTH (latência, DNS/DHCP, QoS/VLANs) usando NMS (NETNUMEN/UNM)
...
**Mai/2016 – Abr/2018 (2a)** | Base em redes LAN/Wi-Fi, Linux/Windows, troubleshooting
...
**Bacharel em Engenharia Elétrica** | Universidade Estácio de Sá | 2020–2024  
*TCC em Machine Learning aplicado a sistemas elétricos*
...
**Análise de Dados:** Power BI • Python (Pandas, NumPy, Jupyter Notebook)
...
- **Python**: CLI tools com design patterns avançados (Singleton, Factory, Async/Await)
...
**SRE & Cloud (2024-2025):**  
✓ Cloud Basics: Development and Basic Concepts (Huawei) - Ago/2025  
✓ Formação Começando com Linux (Alura) - Mai/2024  
✓ Certificação Linux LPI Essentials (Linux Professional Institute) - Jun-Ago/2024  
✓ DevOps: conceitos, comandos e scripts no Linux CLI (Alura) - Jun/2024

**Liderança (2023-2025):**  
✓ Formação Tech Lead (Alura) - Abr/2025  
✓ Mindset digital: liderança remota (Alura) - Out/2023

**Networking (2023):**  
✓ Redes: VLANs, políticas de acesso e internet (Alura) - Ago/2023  
